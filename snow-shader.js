(function() {
  ...
  $(function() {
    var Flake, FlakeFrag, animate, camT, camZ, camZRange, camera, down, flake, flakes, i, kvp, last, material, mesh, moved, params, paused, projector, randInRange, renderer, scene, setSize, speed, stats, sx, sy, twoPi, uniforms, updateCamPos, v, verticesFromSVGPaths, windSpeed, windT, _i, _len, _ref;
    ...
    return $(window).on('mousewheel', function(e, d, dX, dY) {
      camZ -= dY * 5;
      camZ = Math.max(camZ, camZRange[0]);
      camZ = Math.min(camZ, camZRange[1]);
      return updateCamPos();
    });
  });
