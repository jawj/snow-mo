  ...
  $(function() {
    ...
    Flake = (function() {
      ...
      Flake.prototype.reset = function(showOrigin) {
        ...
        this.rootFrag = Math.random() < 0.5 / params.flakes ? null : new FlakeFrag(maxLevel);
    ...
    $(window).on('click', function(ev) {
      var flake, intersects, mesh, meshes, ray, vector, _j, _len2;
      if (moved) {
        return;
      }
      ...
      meshes = (function() {
        ...
        for (_j = 0, _len2 = flakes.length; _j < _len2; _j++) {
          flake = flakes[_j];
          mesh = new THREE.Mesh(new THREE.PlaneGeometry(flake.size * 0.66, flake.size * 0.66), null);
