...
(function() {
  ...
  $(function() {
    var Flake, FlakeFrag, animate, bgColour, camT, camZ, camZRange, camera, casaLogoMessage, doCamPan, doCamZoom, doubleTapDetect, down, dvp, explodeAll, flake, flakeXpode, flakes, halfPi, i, iOS, k, kvp, last, lastTapTime, maxSpeedMultiplier, meshMaterial, moved, oneThirdPi, origCamZoom, params, paused, piOver180, projector, randInRange, renderer, scene, setSize, snowColour, snowMaterial, speed, startCamPan, startCamZoom, stats, stopCamPan, sx, sy, togglePause, toggleSpeed, twoPi, updateCamPos, v, verticesFromSVGPaths, windChange, windSpeed, windT, wls, _i, _len, _ref, _ref1, _ref2;
    ...
    flakeXpode = function(ev) {
      var eventX, eventY, intersects, mesh, meshes, ray, vector, _j, _len1, _results;
      if (moved > 3) {
        return;
      }
