...
(function() {
  ...
  $(function() {
    var Flake, FlakeFrag, animate, bgColour, camT, camZ, camZRange, camera, casaLogoMessage, caster, doCamPan, doCamZoom, doubleTapDetect, down, dvp, explodeAll, flake, flakeXpode, flakes, halfPi, i, iOS, k, kvp, last, lastTapTime, maxSpeedMultiplier, meshMaterial, moved, oneThirdPi, origCamZoom, params, paused, piOver180, projector, randInRange, renderer, scene, setSize, snowColour, snowMaterial, speed, startCamPan, startCamZoom, stats, stopCamPan, sx, sy, togglePause, toggleSpeed, twoPi, updateCamPos, v, verticesFromSVGPaths, windChange, windSpeed, windT, wls, _i, _len, _ref, _ref1, _ref2;
    ...
    verticesFromSVGPaths = function(svg, t) {
      var c, cmd, d, ds, dummy, matches, newV, oldV, origV, re, vertices, x, y, _j, _len1;
      if (t == null) {
        t = new Transform();
      }
      ds = [];
    ...
    FlakeFrag = (function() {
      function FlakeFrag(maxLevel, level) {
        ...
        this.kids = (function() {
          ...
          _results = [];
          for (i = _j = 0, _ref2 = randInRange(1, maxKids); 0 <= _ref2 ? _j <= _ref2 : _j >= _ref2; i = 0 <= _ref2 ? ++_j : --_j) {
      ...
      FlakeFrag.prototype.vertices = function(scale, explodeness) {
        var i, j, t, vertices, _j, _k, _len1, _ref2;
        if (explodeness == null) {
          explodeness = 0;
        }
        vertices = [];
      ...
      FlakeFrag.prototype._vertices = function(vertices, t, explodeness) {
        var c, commonV, kid, _j, _len1, _ref2;
        if (!this.kids) {
          return;
        }
    ...
    flakes = (function() {
      ...
      _results = [];
      for (i = _j = 0, _ref3 = params.flakes; 0 <= _ref3 ? _j < _ref3 : _j > _ref3; i = 0 <= _ref3 ? ++_j : --_j) {
        flake = new Flake();
    ...
    animate = function(t) {
      ...
      if (!paused) {
        for (_j = 0, _len1 = flakes.length; _j < _len1; _j++) {
          flake = flakes[_j];
          flake.tick(dt, wind);
        }
      }
    ...
    flakeXpode = function(ev) {
      var direction, eventX, eventY, intersects, mesh, meshes, vector, _j, _len1, _results;
      if (moved > 3) {
        return;
      }
      ...
      for (_j = 0, _len1 = meshes.length; _j < _len1; _j++) {
        mesh = meshes[_j];
        scene.remove(mesh);
        _results.push(mesh.geometry.dispose());
      }
      return _results;
    };
