...
(function() {
  ...
  $(function() {
    ...
    FlakeFrag = (function() {
      ...
      function FlakeFrag(maxLevel, level) {
        ...
        this.kids = (function() {
          ...
          _results = [];
          for (i = _j = 0, _ref1 = randInRange(1, maxKids); 0 <= _ref1 ? _j <= _ref1 : _j >= _ref1; i = 0 <= _ref1 ? ++_j : --_j) {
      ...
      FlakeFrag.prototype.vertices = function(scale, explodeness) {
        var i, j, t, vertices, _j, _k, _len1, _ref1;
        if (explodeness == null) {
          explodeness = 0;
        }
        vertices = [];
      ...
      FlakeFrag.prototype._vertices = function(vertices, t, explodeness) {
        var c, commonV, kid, _j, _len1, _ref1;
        if (!this.kids) {
          return;
        }
    ...
    dvp = (_ref1 = window.devicePixelRatio) != null ? _ref1 : 1;
